 ...
 * @method     BookQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 ...
 * @method     BookQuery groupByDescription() Group by the description column
 *
 ...
 * @method     Book findOneByDescription(string $description) Return the first Book filtered by the description column
 *
 ...
 * @method     array findByDescription(string $description) Return Book objects filtered by the description column
 *
...
abstract class BaseBookQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `AUTHOR_ID`, `NAME`, `DESCRIPTION` FROM `book` WHERE `ID` = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BookPeer::DESCRIPTION, $description, $comparison);
    }
